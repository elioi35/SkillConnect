  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#8B1C2B] justify-center items-center px-4 py-8">
      <div className="flex flex-col ml-7 items-center justify-center flex-1 px-2 md:px-8 max-w-xl w-full mb-8 md:mb-0">
        ...
        <button className="bg-white text-[#8B1C2B] px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold text-base md:text-lg shadow-lg mb-6 md:mb-8 transition-colors duration-300 self-center hover:bg-white hover:text-black hover:scale-105 transform">
          Get Started
        </button>
      </div>
